...
class AppRoutes {
  ...
  static const String MarketTabScreen = 'MarketTabScreen';
  }
...
Map<String, WidgetBuilder> routes = {
  ...
  AppRoutes.ImagePreviewer: (context) => const ImagePreviewer(),
  ...
  AppRoutes.MarketTabScreen: (context) => const MarketTabScreen(),
};
